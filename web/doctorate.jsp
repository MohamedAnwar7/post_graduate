...
<html lang="en">
    ...
    <head>
        <title>بيانات التسجيل لدرجة الدكتوراه</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="form-container col">
            <form action="doctorate_imp.jsp" class="col-lg-8">
                <label>الاسم :</label>
                ...
                <fieldset class="fieldset-two">
                    ...
                    ۳-
                    <br>
                    <input type="text" name="master_degree" placeholder="درجة الماجيستير في">
                    بتاريخ :
                    <input type="date" name="md_date">
                    <br>
                    <input type="text" name="md_specialization" placeholder="التخصص">
                    <input type="text" name="md_appreciation" placeholder="التقدير">
                    <input type="text" name="md_faculty" placeholder="الكلية">
                    <input type="text" name="md_university" placeholder="الجامعة">
