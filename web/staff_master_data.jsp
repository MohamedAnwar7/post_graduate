            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        ...
                        <a class="dropdown-item" href="style/staff_doctorate_data.jsp">بيانات الدكتوراه</a>
                        <a class="dropdown-item" href="style/staff_master_data.jsp">بيانات الماجستير</a>
                        <a class="dropdown-item" href="style/staff_diploma_data.jsp">بيانات الدبلوم</a>
                        <div class="dropdown-divider"></div>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">بيانات درجة الماجستير</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="master_status.jsp" method="post">
                            ...
                            <br>
                            <input type="submit" class="btn btn-primary" name="submit" value="تم" >
                            </form>
                            <a href="master_report.jsp" class="btn btn-primary" > عمل التقرير</a> <br/>
                        </div>
                    </div>
