...
<html lang="en" dir="rtl">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand static-top">
            ...
            <a class="navbar-brand mr-1" href="staff_home.jsp">القائمة</a>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">بيانات درجة الدكتوراه</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="doctorate_status.jsp" method="post">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> اسم الاول <br></th>
                                                <th> اسم الوالد <br></th>
                                                <th> تاريخ الميلاد <br></th>
                                                <th> قرية <br></th>
                                                <th> مركز <br></th>
                                                <th> محافظة <br></th>
                                                <th> الجنسية <br></th>
                                                <th> الديانة <br></th>
                                                <th> رقم البطاقة <br></th>
                                                <th> موقف التجنيد <br></th>
                                                <th> الوظيفة <br></th>
                                                <th> جهة العمل <br></th>
                                                <th> العنوان <br></th>
                                                <th> رقم التليفون <br></th>
                                                <th> بكالوريوس/ليسانس في <br></th>
                                                <th> دور <br></th>
                                                <th> التقدير العام <br></th>
                                                <th> الشعبة <br></th>
                                                <th> تقدير التخصص <br></th>
                                                <th> الكلية <br></th>
                                                <th> الجامعة <br></th>
                                                <th> سنة التخرج <br></th>
                                                <th> دبلوم الدراسات العليا في <br></th>
                                                <th> دور <br></th>
                                                <th> التخصص <br></th>
                                                <th> التقدير <br></th>
                                                <th> الكلية <br></th>
                                                <th> الجامعة <br></th>
                                                <th> درجة الماجيستير  <br></th>
                                                <th> بتاريخ <br></th>
                                                <th> التخصص <br></th>
                                                <th> التقدير <br></th>
                                                <th> الكلية <br></th>
                                                <th> الجامعة <br></th>
                                                <th> القسم العلمي المتقدم للقيد فيه <br></th>
                                                <th> الحالة <br></th>
                                                <th> معاد المقابلة <br></th>
                                                <th> تقييم المقابلة <br></th>
                            ...
                            <a href="doctorate_report.jsp" class="btn btn-primary" > عمل التقرير</a> <br/>
                        </div>
                    </div>
