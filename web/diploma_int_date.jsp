...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <title>تحديد مواعيد المقابلة</title>
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="style/doctor_home.jsp">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">مواعيد مقابلة طلبة الدبلوم</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="diploma_interview_date.jsp" method="post">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>الاسم الاول<br></th>
                                                <th>اسم العائلة<br></th>
                                                <th>المؤهل الدراسي<br></th>
                                                <th>جهة التخرج<br></th>
                                                <th>سنة التخرج<br></th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="datetime-local" class="form-control" name="<%= counter%>" value = ""></td>                                
