            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb bg-white">
                        ...
                        <li class="breadcrumb-item active">اختيار المقررات</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="course_selection.jsp" method="post">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>                            
                                                ...
                                                <td><input style="width: 20px;"  type ="checkbox" class="form-control" name = "<%= counter%>" value = "<%= counter%>" /></td>  
                                            </tr>
                                        </tbody>
                                        <%
                                                }
                            ...
                            <br>
                            <input type="submit" class="btn btn-primary bg-success" name="submit" value="تأكيد الاختيار" >
                        </div>
                        </form>
                    </div>
                    <br><br>
