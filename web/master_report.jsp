...
<%-- 
    Document   : newjsp1
    Created on : Apr 10, 2019, 6:47:45 PM
    Author     : RAMADAN
--%>
...
<jsp:useBean id="obj" scope="session" class="folder.Data"></jsp:useBean>
    ...
    <head>
        ...
        <title>تقرير طلبة الماجستير</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">تقرير طلبة الماجستير</li>
                    </ol>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <%
                                            try {
                                                ...
                                                String SQL = "select * from faculty.master WHERE status='مطابق للشروط'";
