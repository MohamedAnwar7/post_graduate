                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">إنشاء حساب للدكتور</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="dr_account.jsp">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">إنشاء حساب لشؤن الطلاب</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="staff_account.jsp">
                                <span class="float-left">
                                    <i class="fas fa-angle-left"></i>
                                </span>
                            </a>
