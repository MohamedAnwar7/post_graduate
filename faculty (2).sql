...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2019 at 12:47 AM
...
('IS001', 'Introduction to information system', 3, 'IS', 'null', 'ماجستير'),
('IS002', 'Database I', 3, 'IS', 'حاليا', 'ماجستير'),
('IS003', 'Database II', 3, 'IS', 'null', 'دبلوم'),
('IS004', 'Data Mining', 3, 'IS', '11', 'دكتوراه'),
...
('صالح', 'جمعة', '1980-04-09', '**', '**', 'الاسكندرية', 'مصري', 'مسلم', 90854763259408, 'مؤجل', 'مهندس شبكات', '**', '**', 14865479630, 'بكالريوس حاسبات ومعلومات', 'اكتوبر', 'جيد جدا', 'IT', '', 'حاسبات ومعلومات', 'المنوفية', 20000000, '**', '**', '**', '**', '**', '**', '**', 'مطابق للشروط', '2018-11-30 14:20:00', '3', ''),
('اسامة', 'حسني', '1985-09-30', '**', '**', 'القاهرة', 'مصري', 'مسلم', 90854763259448, 'انهي الخدمة', 'مهندس شبكات', '', '**', 14864479630, 'بكالريوس حاسبات ومعلومات', 'فبراير', 'ممتاز', 'IT', 'ممتاز', 'حاسبات ومعلومات', 'حلوان', 2008, '**', '**', '**', '**', '**', '**', '**', 'غير مطابق للشروط', NULL, '1', '');
...
('باسم', 'علي', '1980-09-04', '**', '**', 'القاهرة', 'مصري', 'مسلم', 55523122314775, 'معفي', 'مهندس برمجيات', '**', '**', 10369998877, 'بكالريوس حاسبات ومعلومات', 'فبراير', '2011', 'IS', 'جيد جدا', 'حاسبات ومعلومات', 'عين شمس', 2005, '**', '**', '**', '**', '**', '**', '**', '2013-09-30', '**', '**', '**', '**', '**', 'غير مطابق للشروط', '2019-10-04 00:00:00', '', '', ''),
...
('سيد', 'معوض', '1970-10-06', '**', '**', 'الغربية', 'مصري', 'مسلم', 9085476329944, 'مؤجل', 'مهندس برمجيات', '**', '**', 1245694464, 'بكالريوس حاسبات ومعلومات', 'اكتوبر', 'جيد جدا', 'CS', '**', 'حاسبات ومعلومات', 'عين شمس', 1995, '**', '**', '**', '**', '**', '--', '**', 'مطابق للشروط', NULL, '', ''),
('حسام', 'حسن', '1970-10-06', '**', '**', 'القاهرة', 'مصري', 'مسلم', 9085876324744, 'مؤجل', 'مهندس برمجيات', '**', '**', 1147194464, 'بكالريوس حاسبات ومعلومات', 'اكتوبر', 'جيد جدا', 'CS', '**', 'حاسبات ومعلومات', 'عين شمس', 1995, '**', '**', '**', '**', '**', '--', '**', 'مطابق للشروط', NULL, '', ''),
('احمد', 'بلال', '1970-10-06', '**', '**', 'الغربية', 'مصري', 'مسلم', 9085876329944, 'مؤجل', 'مهندس برمجيات', '**', '**', 1247194464, 'بكالريوس حاسبات ومعلومات', 'اكتوبر', 'جيد جدا', 'CS', '**', 'حاسبات ومعلومات', 'عين شمس', 1995, '**', '**', '**', '**', '**', '--', '**', 'غير مطابق للشروط', NULL, '', '');
...
('ms1', 'سيد', 'معوض', 'ماجستير', 'CS', '1970-10-06', 9085476329944, 1245694464, 'ms1@ms1', 'ms1', 'مطابق للشروط'),
('ms2', 'حسام', 'حسن', 'ماجستير', 'CS', '1970-10-06', 9085876324744, 1147194464, 'ms2@ms2', 'ms2', 'مطابق للشروط'),
('ms3', 'احمد', 'بلال', 'ماجستير', 'CS', '1970-10-06', 9085876329944, 1247194464, 'ms3@ms3', 'ms3', 'غير مطابق للشروط');
...
(NULL, 'CS003', 'جيد', 1, '2019-05-05', '2019-08-05'),
(NULL, 'CS001', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS0011', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS002', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS001', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS002', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS004', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06'),
(NULL, 'CS004', 'لم يتم التحديد بعد', 1, '2019-05-06', '2019-08-06');
