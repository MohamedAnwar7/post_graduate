                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><b>القسم</b></th>
                                                <th><b>الدرجة</b></th>
                                                <th><b>العام المراد تعديلة</b></th>
                                                <th><b>العام الدراسي الجديد</b></th>
                                            </tr>
                                        </thead>
                                        <%  obj.setc_dept(request.getParameter("dept"));
                                            try {
                            ...
                            <br>
                            <input type="submit" class="btn btn-primary bg-success" name="submit" value="تعديل" >
                        </div>
                        </form>
                    </div>
                    <br><br>
