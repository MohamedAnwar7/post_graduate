...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <title>تقرير طلبة الدكتوراه</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">تقرير طلبة الدكتوراه</li>
                    </ol>
                                      ...
                                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <%
                                            try {
                                                ...
                                                String SQL = "select * from faculty.doctoratee WHERE status='مطابق للشروط'";
