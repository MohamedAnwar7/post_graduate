...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <title>الصفحة الرئيسية|الشئون</title>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-primary o-hidden h-100">
                                ...
                                <a class="card-footer text-white clearfix small z-1" href="staff_doctorate_data.jsp">
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-warning o-hidden h-100">
                                ...
                                <a class="card-footer text-white clearfix small z-1" href="staff_master_data.jsp">
                                    <span class="float-left">
                                        <i class="fas fa-angle-left"></i>
                                    </span>
                                    <span class="float-right">عرض البيانات</span>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card text-white bg-success o-hidden h-100">
                                ...
                                <a class="card-footer text-white clearfix small z-1" href="staff_diploma_data.jsp">
                                    <span class="float-left">
                                        <i class="fas fa-angle-left"></i>
                                    </span>
                                    <span class="float-right">عرض البيانات</span>
