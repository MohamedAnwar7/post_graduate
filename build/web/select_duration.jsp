        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">تحديد موعد فتح المقررات</li>
                </ol>
                ...
                <div class="row">
                        <div class="col-md-8 margin-form">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form name="my-form" id="my-form" action="selection_duration_imp.jsp" method="post">

                                            <div class="form-group row">
                                                <label  class="col-md-3 col-form-label text-md-right">دورة شهر</label>
                                                <div class="col-md-6">
                                                    <input type="text" id="dept" class="form-control" name="fisrt_round" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label  class="col-md-3 col-form-label text-md-right">دورة شهر</label>
                                                <div class="col-md-6">
                                                    <input type="text" id="dept" class="form-control" name="second_round" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12 text-center">
                                                <button type="submit" name="submit" style="width: 20%" class="btn btn-primary" >حفظ</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
