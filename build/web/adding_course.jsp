    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="search_dept.html">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">اضافة مقررات</li>
                    </ol>
                    ...
                    <div class="row">
                            <div class="col-md-8 margin-form">
                                    <div class="card">
                                        <div class="card-header">اضافة مقرر</div>
                                        <div class="card-body">
                                            <form name="my-form" id="my-form" action="adding_course_imp.jsp" method="post">
                                                <div class="form-group row">
                                                    <label  class="col-md-4 col-form-label text-md-right">كود المقرر</label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-md-4 col-form-label text-md-right">اسم المقرر</label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-md-4 col-form-label text-md-right">عدد الساعات</label>
                                                    <div class="col-md-6">
                                                        <input type="text" id="num_hours" class="form-control" name="num_hours" required>
                                                    </div>
                                                </div>
            
                                                <div class="form-group row">
                                                    <label class="col-md-4 col-form-label text-md-right">القسم</label>
                                                    <div class="col-md-3">
                                                        <input type="text" id="num_hours" class="form-control" name="num_hours" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label  class="col-md-4 col-form-label text-md-right">العام الدراسي</label>
                                                    <div class="col-md-6">
                                                        <select name="stud_year" class="form-control">
                                                ...
                                                <div class="form-group row">
                                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">الدرجة</label>
                                                    <div class="col-md-6">
                                                        <input type="text" id="degree_type" class="form-control"
